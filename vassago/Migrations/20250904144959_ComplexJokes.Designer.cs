...
namespace vassago.Migrations
{
    ...
    [Migration("20250904144959_ComplexJokes")]
    partial class ComplexJokes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("vassago.Models.Joke", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<int>("LewdnessConformity")
                        .HasColumnType("integer");

                    b.Property<int>("MeannessConformity")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("vassago.Models.ProtocolConfiguration", b =>
                {
                    ...
                    b.Property<Guid?>("SelfChannelId")
                        .HasColumnType("uuid");

                    b.HasKey("Id");

                    b.HasIndex("SelfChannelId");
            ...
            modelBuilder.Entity("vassago.Models.ProtocolExternal", b =>
                {
                    b.HasBaseType("vassago.Models.ProtocolConfiguration");
                    ...
                    b.HasDiscriminator().HasValue("ProtocolExternal");
                });
            ...
            modelBuilder.Entity("vassago.Models.ProtocolConfiguration", b =>
                {
                    b.HasOne("vassago.Models.Channel", "SelfChannel")
                        .WithMany()
                        .HasForeignKey("SelfChannelId");

                    b.Navigation("SelfChannel");
                });
